...
import joinroom from '../../onboard/joinroom.css';
    ...
    return (
      <React.Fragment>
        {opponentDidJoinTheGame ? (
                <div>
                    <h4 style={{marginLeft:"250px",marginTop:'50px',marginBottom:'30px'}}> Opponent: {opponentUserName} </h4>
            ...
            <h4 style={{marginTop:'50px',marginBottom:'30px'}}> You: {props.myUserName} </h4>
          </div>
        ) : gameSessionDoesNotExist ? (
          <div>
            <h1 style={{ textAlign: "center", marginTop: "200px",marginBottom:'50px' }}> Sorry!! Session expired :( </h1>
          </div>
        ) : (
          <div>
            <h1
