...
class sideBar1 extends React.Component {
    ...
    render() {
        ...
        const onPageLoad = () => { 
            ...
            if (this.props.onRefresh === '/youarein_news') {
            ...
            <div>
                ...
                <div className="sidebar-div">
                    <div className="ui  secondary pointing inverted vertical icon menu" style={{ marginTop: '15px' }} ref={this.myRef}>
                        <Link to="/youarein"><a className={this.state.home ? 'active item clr' : 'item clr1'} style={{ marginBottom: '20px',marginTop:'20px' }} onClick={this.onClickhome}>
                            <div class="ui icon " data-tooltip="Home" data-position="right center">
                                <i class=" home icon"></i>
                            </div>
                        </a></Link>
                        <Link to="/youarein_about"><a className={this.state.about ? 'active item clr' : 'item clr1'} style={{ marginBottom: '10px' }} onClick={this.onClickabout}>
                            <div class="ui icon " data-tooltip="About" data-position="right center">
                                <i class=" user icon " ></i>
                            </div>

                        </a></Link>
                        <Link to="/youarein_contact"><a className={this.state.contact ? 'active item clr' : 'item clr1'} style={{ marginBottom: '20px' }} onClick={this.onClickcontact}>
                            <div class="ui icon " data-tooltip="Contact" data-position="right center">
                                <i class=" phone icon " ></i>
                            </div>

                        </a></Link>
                        <Link to="/youarein_search" className={this.state.search ? 'active item clr' : 'item clr1'} style={{ marginBottom: '20px' }} onClick={this.onClicksearch}><a>
                            <div class="ui icon " data-tooltip="Search" data-position="right center">
                                <i className="search icon"></i>
                            </div>
                        </a></Link>
                        <Link to="/youarein_news" className={this.state.news ? 'active item clr' : 'item clr1'}  onClick={this.onClicknews}><a>
